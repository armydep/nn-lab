"""The tiny GPT model -- Chapter 9's Transformer, refined for a real corpus.

Only change from Chapter 9: dropout is now used, since a real corpus makes
overfitting a genuine concern.
"""
